...
class MemoryEvent(BaseModel):
    ...
    relevant_clause_ids: List[str] = Field(
        ...
        description="Relevant clause/document IDs",
    )
    ...
    extra_context: Dict[str, Any] = Field(
        default_factory=dict,
        description="Any extra context or metadata",
    )
    summary: Optional[str] = Field(
        default=None,
        description="Summary of the memory event",
    )
    # below source, llm_confidence and user_feedback fields
    ...
    llm_confidence: Optional[float] = Field(
        default=None,
        description="LLM confidence of probability score",
    )
